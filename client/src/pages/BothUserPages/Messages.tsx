...
const Messages = () => {
  ...
  return (
    <div className="flex sm:mx-0 h-[40rem] sm:h-[450px] md:h-[530px] rounded-lg overflow-hidden bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 ">
